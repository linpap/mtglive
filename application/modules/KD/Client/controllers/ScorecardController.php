...
//			echo '<pre>';
//			print_r($maalplanMaalInfo);exit();

			$this->view->maalplanMaalInfo = $maalplanMaalInfo;

			$maalplanMaal = KD::getModel('client/maalplanmaal')->loadMaalList($clientID,$maalplanInfo['maalplan_id'],'all');
//			echo "<pre>";
//			print_r($maalplanMaal);
//			die;
			$this->view->maalplanMaal = $maalplanMaal;
			//echo '<pre>';print_r($maalplanInfo);exit();
...
//					echo "<pre>";
//					print_r($maalplanMaalInfo);
//					die;

					$this->view->maalplanMaalInfo = $maalplanMaalInfo;
					$maalplanMaal = KD::getModel('client/maalplanmaal')->loadMaalList($clientID,$maalPlanID,'all');
