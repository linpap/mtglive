...
class KD_Vaktrapport_Middleware_Deviation {
    ...
    protected function _notify($patientId) {
        ...
        $emailAddress=array('knunor@behandlingssenteret.no','dag.skadinn@behandlingssenteret.no','joasol@behandlingssenteret.no','tor.einar.stien.thorvaldsen@behandlingssenteret.no','payam@webtech-it.no');
